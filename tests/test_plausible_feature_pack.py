"""Smoke tests for the ``plausible`` feature pack."""
...
from app.features.plausible import PACK
...
def test_plausible_pack_manifest_declares_all_routes():
    declared = set()
    ...
    assert PACK.slug == "plausible"
    assert PACK.version
    assert declared == EXPECTED


def test_app_main_no_longer_owns_plausible_routes():
...
def test_plausible_pack_loads_and_reloads_cleanly():
    import asyncio
