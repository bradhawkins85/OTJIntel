"""Smoke tests for the ``invoices`` feature pack."""
...
from app.features.invoices import PACK
...
def test_invoices_pack_manifest_declares_all_routes():
    declared = set()
    ...
    assert PACK.slug == "invoices"
    assert PACK.version
    assert declared == EXPECTED


def test_app_main_no_longer_owns_invoice_routes():
