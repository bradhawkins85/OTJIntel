"""Smoke tests for the ``smtp`` feature pack."""
...
from app.features.smtp import PACK
...
def test_smtp_pack_manifest_declares_all_routes():
    declared = set()
