...
MODULE_CAPABILITIES: dict[str, ModuleCapabilities] = {
    ...
    "tacticalrmm": _c(commands=("sync_tactical_assets", "push_tactical_companies", "pull_tactical_companies", "refresh_company_ids"), routes=("tacticalrmm.actions",), services=("tacticalrmm.api", "tacticalrmm.company_sync"), ui=("tacticalrmm",)),
